      ...
      <div className="max-w-md w-full">
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-gray-900 mb-2">Registrar Portal</h1>
            <p className="text-gray-600">Sign in to manage student documents</p>
          </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-600">
              Registrar Login: registrar@university.edu.in / registrar123
            </p>
          </div>
        </div>
      </div>
